...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastApi.BaseQuery();
  });
  ...
  describe('BaseQuery', function() {
    it('should create an instance of BaseQuery', function() {
      // uncomment below and update the code to test BaseQuery
      //var instane = new FastApi.BaseQuery();
      //expect(instance).to.be.a(FastApi.BaseQuery);
    });
