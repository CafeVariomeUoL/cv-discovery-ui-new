...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FastApi.GroupQuery();
  });
  ...
  describe('GroupQuery', function() {
    it('should create an instance of GroupQuery', function() {
      // uncomment below and update the code to test GroupQuery
      //var instane = new FastApi.GroupQuery();
      //expect(instance).to.be.a(FastApi.GroupQuery);
    });
